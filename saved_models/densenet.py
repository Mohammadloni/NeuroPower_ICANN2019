...
def DenseNet(input_shape=None, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=-1, nb_layers_per_block=-1,
             ...
             include_top=True, weights=None, activation_conv=None, input_tensor=None,
    ...
    x = __create_dense_net(classes, img_input, include_top, depth, nb_dense_block,
                           ...
                           dropout_rate, weight_decay, subsample_initial_block, activation, activation_conv= activation_conv)
...
def __conv_block(ip, nb_filter, bottleneck=False, dropout_rate=None, weight_decay=1e-4, activation_conv=''):
...
def __dense_block(x, nb_layers, nb_filter, growth_rate, bottleneck=False, dropout_rate=None, weight_decay=1e-4,
                  grow_nb_filters=True, return_concat_list=False, activation_conv=''):
    ...
    for i in range(nb_layers):
        cb = __conv_block(x, growth_rate, bottleneck, dropout_rate, weight_decay, activation_conv=activation_conv)
        x_list.append(cb)
...
def __transition_block(ip, nb_filter, compression=1.0, weight_decay=1e-4, activation_conv=''):
...
def __create_dense_net(nb_classes, img_input, include_top, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=-1,
                       ...
                       subsample_initial_block=False, activation='softmax', activation_conv=''):
    ...
    for block_idx in range(nb_dense_block - 1):
        x, nb_filter = __dense_block(x, nb_layers[block_idx], nb_filter, growth_rate, bottleneck=bottleneck,
                                     dropout_rate=dropout_rate, weight_decay=weight_decay, activation_conv=activation_conv)
        # add transition_block
        x = __transition_block(x, nb_filter, compression=compression, weight_decay=weight_decay, activation_conv=activation_conv)
